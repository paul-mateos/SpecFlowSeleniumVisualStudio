Feature: MessageNotification on user not logged in
	#- Configuration:
...
Scenario Outline: MessageNotification: OpenDocument Notification to inactive user
   ...
   Examples: valid section_inactiveUser
...
@MessageNotification_InactiveUser
Scenario Outline: MessageNotification: DoSearch Notification to inactive user
...
@MessageNotification_InactiveUser
Scenario Outline: MessageNotification: DoCshSearch Notification to Inactive user
