...
#line hidden
        ...
        public virtual void OpenDocumentAPIInvalidValues(string apiKey, string findUserBy, string user, string documentID, string version, string sectionID, string anchorName, string dateTime, string description, string actions, string pageContentToVerify, string errorCode, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("OpenDocument API: Invalid Values", @__tags);
#line 26
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("OpenDocument API: Invalid Values")]
        ...
        public virtual void OpenDocumentAPIInvalidValues_InvalidApiKey_Invalidkey()
        {
            this.OpenDocumentAPIInvalidValues("Invalidkey", "", "viewer", "111", "1.0", "", "", "", "", "", "", "401", ((string[])(null)));
        }
        ...
        public virtual void OpenDocumentAPIInvalidValues_InvalidUser_Key()
        {
            this.OpenDocumentAPIInvalidValues("key", "id", "viewer", "111", "1.0", "", "", "", "", "", "", "400", ((string[])(null)));
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:PageContentToVerify", "")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:ErrorCode", "400")]
        public virtual void OpenDocumentAPIInvalidValues_InvalidDocID_Key()
        {
            this.OpenDocumentAPIInvalidValues("key", "", "viewer", "222", "1.0", "", "", "", "", "", "", "400", ((string[])(null)));
        }
        
        public virtual void DoSearchAPIInvalidValues(string apiKey, string findUserBy, string user, string query, string filters, string dateTime, string description, string showFirstResult, string actions, string numOfDocsShouldShow, string errorCode, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "MessageNotification.ErrorCode"};
            if ((exampleTags != null))
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("DoSearchAPI: Invalid Values", @__tags);
#line 44
this.ScenarioSetup(scenarioInfo);
#line 22
this.FeatureBackground();
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("DoSearchAPI: Invalid Values")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "MessageNotification Rainy day scenarios")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("MessageNotification.ErrorCode")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("ExampleSetName", "Invalid ApiKey")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("VariantName", "invalidkey")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:ErrorCode", "401")]
        public virtual void DoSearchAPIInvalidValues_InvalidApiKey_Invalidkey()
        {
            this.DoSearchAPIInvalidValues("invalidkey", "", "viewer", "ActionOnDoSearch2Results", "", "", "search", "false", "", "", "401", ((string[])(null)));
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:NumOfDocsShouldShow", "")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:ErrorCode", "400")]
        public virtual void DoSearchAPIInvalidValues_InvalidUser_Key()
        {
            this.DoSearchAPIInvalidValues("key", "id", "viewer", "ActionOnDoSearch2Results", "", "", "search", "false", "", "", "400", ((string[])(null)));
        }
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("MessageNotification: Notification is cached")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "MessageNotification Rainy day scenarios")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.IgnoreAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("MessageNotification")]
        public virtual void MessageNotificationNotificationIsCached()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("MessageNotification: Notification is cached", new string[] {
                        "ignore",
                        "MessageNotification"});
#line 72
this.ScenarioSetup(scenarioInfo);
